...
fitT1=fminsearch('IRfit',[guessMI guessM0 guessT1],[],double(TIlist)./1000000,double(magnitude_series(:)))


% eval(['save data_T1_saved experiment true_experiment CPXechoes_pos CPXechoes_neg TIlist Tcpmg BW Nseq echovalues_mean magnitude_series T2a_series fitT1'])